function createDataset(fields, constraints, sortFields) {
	...
	var choosedState = "185"; // Atividade que a solicitação deve ficar após abertura
	var numProcesso = "22149"; // Número da solicitação
	var usuario = "sergio.machado"; // matricula do usuário
