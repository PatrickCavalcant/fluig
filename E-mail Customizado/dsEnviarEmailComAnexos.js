...
function enviarEmail(nomeRemetente, assunto, conteudo, textoPlano, destinatario, responderPara, copia, copiaOculta, anexos) {
    ...
    try {
        ...
        var emailRemetente = "fluig@gmail.com";
        var senha = "SENHA_USUARIO_APLICATIVO";
...
function adicionaAnexo(multipart, id, versao, nomeArquivo, descArquivo) {
    try {
        ...
        var caminhoArquivo = dirDefault + sep + "public" + sep + id + sep + versao + sep + nomeArquivo;
        ...
        attachment.setDataHandler(
            new javax.activation.DataHandler(
                new javax.activation.FileDataSource(arquivo)
            )
        );
        ...
        throw ("function " + arguments.callee.name + " => " + err);
    }
}
